...
define(function (require, exports, module) {
    ...
    require("daadisplays/daa-displays-min/templates/daa-compass-templates.js");
    const strokeWidth = 8;
    ...
    class ResolutionBug {
        ...
        refresh() {
            ...
            $("." + this.id + "-bg").css({
                "background-color": bugColors[alert]
            });
            $("." + this.id + "-bl").css({
                "border-left": "2px dashed " + bugColors[alert]
            });
            return this;
        }
    }
    ...
    function _update_compass(_this, opt) {
        ...
        if (_this.nrthup) {
            $("#" + _this.id + "-circle").css({
                "transition-duration": opt.transitionDuration,
                "transform": "rotate(0deg)"
            }); // compass needs counter-clockwise rotation
            ...
            $("#" + _this.id + "-top-indicator-pointer").css({
                "display": "none"
            });
            $("#" + _this.id + "-daa-ownship").css({
                "transition-duration": opt.transitionDuration,
