...
export class Indicators {
    constructor(id) {
        ...
        function addGpsIndicator() {
            ...
            im.setAttribute("src", "./MainJS/Indicators/images/gps.svg");
        ...
        function addBatteryIndicator() {
            ...
            im.setAttribute("src", "./MainJS/Indicators/images/battery.svg");
            im.setAttribute('class', 'red')
            let inner = document.createElement('div')
        ...
        function addRadioIndicator() {
            ...
            im.setAttribute('src', './MainJS/Indicators/images/media-signal-tower-svgrepo-com.svg')
            im.setAttribute('class', 'red')
            let inner = document.createElement('div')
