...
export function createSettingsPanel() {
    ...
    // }))
    conn_div.appendChild(addBlockButton('new_connection', '', 'Change Connection', comms.createNewConnection))
    ...
    link.setAttribute('href', 'localhost:8082/docs/index.html')
    link.innerHTML = 'Documentation'
    mode_set_div.appendChild(link)
 ...
 * @memberof module:form
 */
export function updateTable(table, id, type, count, f_a = 0, f_r = 0, center = map.getCenter(), a, alt = 10) {
 ...
 * @memberof module:form
 */
export function addRowToTable(id, type, count, f_a = 0, f_r = 0, center = map.getCenter(), a = 1, alt = 10) {
